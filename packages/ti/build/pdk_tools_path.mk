...
ifeq ($(PDK_VERSION),)
  ...
  GCC_CROSS_TOOL_TAG=7-2017-q4-major-win32
  GCC_ARCH64_VERSION=7.2.1-2017.11

  CGT_C7X_VERSION=1.2.0.STS
  CGT_ARM_VERSION=20.2.1.LTS
  GCC_VERSION_HARDLIB=7.2.1
...
ifeq ($(BOARD),$(filter $(BOARD), tpr12_evm))
  ...
  BIOS_VERSION=6_73_01_01
  XDC_VERSION=3_61_02_27_core
  CGT_VERSION=8.3.2
endif
...
ifeq ($(OS),Windows_NT)
  ...
  export XDC_INSTALL_PATH          ?= $(SDK_INSTALL_PATH)/ccs1010/xdctools_$(XDC_VERSION)
