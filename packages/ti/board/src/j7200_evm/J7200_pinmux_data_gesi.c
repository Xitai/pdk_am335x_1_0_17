...
*
* \file  J7200_pinmux_data_gesi.c
*
* \brief  This file contains the pin mux configurations for the boards.
*         These are prepared based on how the peripherals are extended on
*         the boards.
*
* \copyright Copyright (CU) 2010 Texas Instruments Incorporated -
*             http://www.ti.com/
*/
...
pinmuxBoardCfg_t gJ7200_MainPinmuxDataGesiIcssg[] =
{
    {0, gEhrpwmPinCfg},
    {1, gEqepPinCfg},
    {2, gGpioPinCfg},
...
pinmuxBoardCfg_t gJ7200_WkupPinmuxDataGesiIcssg[] =
{
    {0, gMcu_adcPinCfg},
    {1, gWkup_gpioPinCfg},
    {PINMUX_END}
